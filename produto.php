...
<?php if($_SESSION['log'] == "logado"){?>
	<html lang="pt-br">
		...
		<body>
		<?php
			include_once("header/header_produto.php");
		...
		<div class="container theme-showcase" role="main">
			...
			// if($_SESSION['permissao']=="1"){?>
				<!-- <div class="pull-right">
					<a href="http://logus.freevar.com/arquivo.php"><button type="button" class="quadrinhoarredondadoexemplo" >Gerar relatório</button></a>
				</div> -->
				<!-- <div class="pull-right">
