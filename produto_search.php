...
<?php if($_SESSION['log'] == "logado"){?> 
	<html lang="pt-br">
		...
		<body>
		<?php include_once("header/header_produto.php")?>
		<div class="container theme-showcase" role="main">
			<div class="page-header">		
				...
				<a href="http://logus.freevar.com/produto.php"><button type="button" class="quadrinhoarredondadoexemplo pull-right">Exibir produtos</button></a>
