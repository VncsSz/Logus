<?php
	...
	include("modal.php");
	$result_cursos = "SELECT * FROM usuario";
	$resultado_cursos = mysqli_query($conn, $result_cursos);
	$nome = mysqli_real_escape_string($conn, $_POST['nomeproduto']);
    $result_search = "SELECT * FROM usuario WHERE nome LIKE '%$nome%'";
...
<?php if($_SESSION['log'] == "logado"){?>
	<html lang="pt-br">
		...
		<body>
		<?php include_once("header/header_funcionario.php")?>
		<div class="container theme-showcase" role="main">
			<div class="page-header">		
				<a href="http://logus.freevar.com/arquivo.php"><button type="button" class="quadrinhoarredondadoexemplo pull-right" >Gerar relatório</button></a>
				...
				<a href="http://logus.freevar.com/produto.php"><button type="button" class="quadrinhoarredondadoexemplo pull-right">Exibir Funcionários</button></a>
									...
									<div class="modal fade" id="exampleModal<?php echo $rows_produto['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
														<form method="POST" action="http://logus.freevar.com/produto_update.php" enctype="multipart/form-data">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form method="POST" action="http://logus.freevar.com/estock1/produto_delete.php" enctype="multipart/form-data">
