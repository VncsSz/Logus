        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="http://logus.freevar.com/produto_create.php" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="myModalcadCat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="http://logus.freevar.com/categoria_create.php" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="myModalCadFunc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="http://logus.freevar.com/funcionario_create.php" enctype="multipart/form-data">
                        <div class="form-group">
